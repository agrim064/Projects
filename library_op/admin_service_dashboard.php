...
.innerdiv {
    text-align: center; 
    /* width: 500px;  Library ki picture */
    margin: 10px;
}
input{
    margin-left:15px; /* Distance between author and text fields*/
}
.leftinnerdiv {
    float: left;
    width: 25%; /* sare add book , issue book wale */
}

.rightinnerdiv {
    float: right; /*  data entry ka content  */
    width: 75%;  
}

.innerright {
    background-color: wheat; /*Box ka color jo wheat jaisa ha  */ 
}

.greenbtn {
    background-color: yellow;
    color: blue;
    width: 95%;  /*width of add content wale box*/
    height: 50px; /* height of the box*/
    margin-top: 8px; /* distance between them */
}
...
td, a{
    color:black;
        ...
        label {
            margin-left:10px;
            padding-Top:10px; /* distance bw the contents */
            /* display: block;
            text-align: left; */
            font-size: 18px;
            /* font-style:bold;
